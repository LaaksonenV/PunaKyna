/* This program extracts the contents of <textarea>s from a HTML page. Some
  effort has been made to avoid being fooled by such cases as <textarea
  attribute = "...>">, but not very much. The program can be compiled as a
  command-line program or (#define cgibin) cgi-program.
*/
/* Copyright Antti Valmari 2017-08-04 */
#include <iostream>
...
/* Find, decode, and print the contents of the textareas. */
int main(){
  inp_start();
  ...
  std::cout << "<title>MathCheck (extracted textareas)</title>\n";
  std::cout << "<link rel=stylesheet type=\"text/css\" href=\n\"" << URL_css;
  std::cout << "\">\n</head>\n\n<body>\n\n";
  std::cout << "<h1 class=teacher>MathCheck (extracted textareas)</h1>\n";
  std::cout << "\n<form action=\n\"" << URL_cgi_base
